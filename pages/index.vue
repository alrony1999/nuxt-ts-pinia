...
const login = async () => {
    const userWithToken = await authStore.login({
        email: email.value,
        password: password.value,
    });

    if (userWithToken) {
        authStore.setUser(userWithToken.user);
        authStore.setBearerToken(userWithToken.token);
        ...
        await ElMessageBox.alert("Invalid Credentials", {
